package com.example.power.androidstudiolatestproject;
...
public class LatestDemo extends Activity implements OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latest_demo);
        ...
        switch(view.getId()) {
            ...
            case R.id.playBtn:
                try {
                    ...
                    Toast.makeText(getBaseContext(),"Can't play file",Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
                break;
            case R.id.assocBtn:
